...
public class no_fosforo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_no_fosforo);
        ...
        String url = "https://www.dashblog.cl/showProhibicion.php";
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                datos.add(new DietaItem(nombre, contenido, imageUrl));
                            }
    ...
    private class DietaItem {
        ...
        public DietaItem(String nombre, String contenido, String imagenUrl) {
            this.nombre = nombre;
