...
public class Listado_dieta_altaMasaMusc_viernes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listado_dieta_alta_masa_musc_viernes);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            if (response.length() > 0) {
                                JSONObject jsonObject = response.getJSONObject(32);
