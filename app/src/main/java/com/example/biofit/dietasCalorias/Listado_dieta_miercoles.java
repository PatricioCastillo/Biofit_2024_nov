package com.example.biofit.dietasCalorias;
...
public class Listado_dieta_miercoles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listado_dieta_miercoles);
